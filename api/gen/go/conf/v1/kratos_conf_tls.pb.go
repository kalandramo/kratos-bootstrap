...
const file_conf_v1_kratos_conf_tls_proto_rawDesc = "" +
	"\n" +
	"\x1dconf/v1/kratos_conf_tls.proto\x12\aconf.v1\"\xc2\x03\n" +
	"\x03TLS\x12*\n" +
	"\x04file\x18\x01 \x01(\v2\x11.conf.v1.TLS.FileH\x00R\x04file\x88\x01\x01\x120\n" +
	"\x06config\x18\x02 \x01(\v2\x13.conf.v1.TLS.ConfigH\x01R\x06config\x88\x01\x01\x120\n" +
	...
	"\x05_fileB\t\n" +
	"\a_configB\xa0\x01\n" +
	"\vcom.conf.v1B\x12KratosConfTlsProtoP\x01Z@github.com/kalandramo/kratos-bootstrap/api/gen/go/conf/v1;confv1\xa2\x02\x03CXX\xaa\x02\aConf.V1\xca\x02\aConf\\V1\xe2\x02\x13Conf\\V1\\GPBMetadata\xea\x02\bConf::V1b\x06proto3"
...
var file_conf_v1_kratos_conf_tls_proto_goTypes = []any{
	(*TLS)(nil),        // 0: conf.v1.TLS
	(*TLS_File)(nil),   // 1: conf.v1.TLS.File
	(*TLS_Config)(nil), // 2: conf.v1.TLS.Config
}
var file_conf_v1_kratos_conf_tls_proto_depIdxs = []int32{
	1, // 0: conf.v1.TLS.file:type_name -> conf.v1.TLS.File
	2, // 1: conf.v1.TLS.config:type_name -> conf.v1.TLS.Config
